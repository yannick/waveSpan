...
// NamespaceConfig sets per-namespace policy: the conflict resolver and whether writes must be
// globally durable (block the local ACK when the out-log is full).
