...
func SurfaceForProcedure(procedure string) Surface {
	switch procedure {
	case "/wavespan.v1.KvService/Get", "/wavespan.v1.KvService/MultiGet", "/wavespan.v1.KvService/Scan", "/wavespan.v1.Cypher/Query",
		...
		"/wavespan.v1.ObservabilityService/GraphExplore", "/wavespan.v1.ObservabilityService/GraphSubgraph":
	...
	case "/wavespan.v1.ReplicationService/StoreReplica", "/wavespan.v1.ReplicationService/FetchReplica",
		"/wavespan.v1.ReplicationService/SubscribeKey", "/wavespan.v1.ReplicationService/ScanLocal", "/wavespan.v1.ReplicationService/Backfill",
